            ...
            <tr>
                ...
                <td align="center">
                    <?php if ($box1 != 9 && $box2 != 9 && $box3 != 9) { ?>
                        <a href="proses.php?nav=up&b1=<?php echo $box1; ?>&b2=<?php echo $box2; ?>&b3=<?php echo $box3; ?>&b4=<?php echo $box4; ?>&b5=<?php echo $box5; ?>&b6=<?php echo $box6; ?>&b7=<?php echo $box7; ?>&b8=<?php echo $box8; ?>&b9=<?php echo $box9; ?>&savenav=NULL">
                            <button
            ...
            <tr>
                <td align="center">
                    <?php if ($box1 != 9 && $box4 != 9 && $box7 != 9) { ?>
                        <a href="proses.php?nav=left&b1=<?php echo $box1; ?>&b2=<?php echo $box2; ?>&b3=<?php echo $box3; ?>&b4=<?php echo $box4; ?>&b5=<?php echo $box5; ?>&b6=<?php echo $box6; ?>&b7=<?php echo $box7; ?>&b8=<?php echo $box8; ?>&b9=<?php echo $box9; ?>&savenav=NULL">
                            <button
                ...
                <td align="center">
                    <?php if ($box3 != 9 && $box6 != 9 && $box9 != 9) { ?>
                        <a href="proses.php?nav=right&b1=<?php echo $box1; ?>&b2=<?php echo $box2; ?>&b3=<?php echo $box3; ?>&b4=<?php echo $box4; ?>&b5=<?php echo $box5; ?>&b6=<?php echo $box6; ?>&b7=<?php echo $box7; ?>&b8=<?php echo $box8; ?>&b9=<?php echo $box9; ?>&savenav=NULL">
                            <button
            ...
            <tr>
                ...
                <td align="center">
                    <?php if ($box7 != 9 && $box8 != 9 && $box9 != 9) { ?>
                        <a href="proses.php?nav=down&b1=<?php echo $box1; ?>&b2=<?php echo $box2; ?>&b3=<?php echo $box3; ?>&b4=<?php echo $box4; ?>&b5=<?php echo $box5; ?>&b6=<?php echo $box6; ?>&b7=<?php echo $box7; ?>&b8=<?php echo $box8; ?>&b9=<?php echo $box9; ?>&savenav=NULL">
                            <button
